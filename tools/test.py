...
# python test.py ../custom_configs/faster_rcnn_x101_64x4d_fpn_2x_coco.py ../work_dirs/faster_rcnn_x101_64x4d_fpn_2x_coco_exp_05-09-14\:20\:45/latest.pth --work-dir ../confusion_matrix/ --out ../confusion_matrix/output.pkl
import argparse
import os
